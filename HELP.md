...
* The original package name 'com.ecommerce.shopping .ecommerce-user-pannel-api' is invalid and this project uses 'com.ecommerce.shopping.ecommerceuserpannelapi' instead.
...
* [Create an OCI url](https://docs.spring.io/spring-boot/docs/3.1.2/gradle-plugin/reference/html/#build-image)
